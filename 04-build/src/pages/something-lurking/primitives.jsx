...
export const SL_NAV = [
  ...
  { id: 'translation', label: 'What We Built' },
...
export function LinkButton({ href, children }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 rounded-md border border-[#6E3FB3]/40 bg-[#6E3FB3]/[0.08] px-4 py-2 font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.16em] text-[#9268E0] transition-colors hover:border-[#6E3FB3] hover:bg-[#6E3FB3]/[0.16] hover:text-white"
    >
      {children}
    </a>
  )
...
export function Highlight({ children, className = '' }) {
  return (
    <mark
      className={`box-decoration-clone rounded-[3px] bg-[#6E3FB3]/30 px-1.5 py-0.5 font-medium text-white ${className}`}
    >
      {children}
    </mark>
  )
