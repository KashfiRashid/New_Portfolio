  ...
  return (
    <section id="concept" className="scroll-mt-28 py-20 lg:py-32">
      ...
      <div className="mt-8 max-w-[720px] space-y-6 font-[family-name:var(--font-sans)] text-lg leading-relaxed text-zinc-300 lg:text-xl">
        ...
        <p>
          ForeSee organizes finances by the people you spend with. Work, Friends, Spouse, Personal. Each board is a living feed of events with the real transactions linked underneath.
        </p>
      </div>
    </section>
  )
