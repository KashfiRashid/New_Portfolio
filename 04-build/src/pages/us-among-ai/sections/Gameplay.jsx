  ...
  return (
    <section id="how-it-plays" className="scroll-mt-28 py-20 lg:py-32">
      ...
      <div className="mt-10 max-w-[720px] space-y-6 font-[family-name:var(--font-sans)] text-lg leading-relaxed text-zinc-300 lg:text-xl">
        ...
        <p>
          Finish, and the system delivers a verdict: <strong className="text-white">ACCEPTED, as artificial intelligence</strong>, or <strong className="text-white">FLAGGED, as human</strong>.
        </p>
      </div>
    </section>
  )
