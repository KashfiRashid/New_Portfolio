  ...
  return (
    <section id="what-i-did" className="scroll-mt-28 py-20 lg:py-32">
      ...
      <div className="mt-8 max-w-[720px] space-y-6 font-[family-name:var(--font-sans)] text-lg leading-relaxed text-zinc-300 lg:text-xl">
        ...
        <p>
          From there I worked across design and development, keeping four people aligned on one direction under time pressure. The look (futuristic, minimalist, glowing neon) came from growing up on Pok&eacute;mon on retro PSPs and a recent obsession with Stardew Valley.
        </p>
      </div>
    </section>
  )
