  ...
  return (
    <section id="overview" className="scroll-mt-28 py-20 lg:py-32">
      ...
      <div className="mt-8 max-w-[720px] space-y-6 font-[family-name:var(--font-sans)] text-lg leading-relaxed text-zinc-200 lg:text-xl">
        <p>
          BLU is a three-act CG animated short produced over the summer of 2025 in a CG Animation studio at SFU SIAT. A team of six built it across roughly ten weeks. A curious duckling crosses out of a glowing meadow into a wasteland it was warned to avoid, chasing a blue feather that is beautiful and probably not safe.
        </p>
        <p>
