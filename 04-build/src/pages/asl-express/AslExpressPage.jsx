...
import Signify from './sections/Signify.jsx'
...
export default function AslExpressPage() {
  ...
  return (
    <div
      className="relative min-h-screen bg-[#0B120F] text-zinc-200 antialiased selection:bg-[#10B981]/30"
      style={{
    ...
    >
      <div
        className="pointer-events-none fixed inset-0 bg-gradient-to-br from-emerald-950/[0.10] via-transparent to-transparent"
        aria-hidden
      />
