...
export default function CognitiveOverloadContrast() {
  return (
    ...
    >
      ...
      {/* BEFORE phone */}
      <g>
        <text x="120" y="24" fill="#71717a" fontFamily={MONO} fontSize="12" letterSpacing="1.6" textAnchor="middle">
          BEFORE
        </text>
        <text x="120" y="40" fill="#52525b" fontFamily={SANS} fontSize="11" textAnchor="middle" fontStyle="italic">
          cluttered information, out of order
        </text>
        {/* phone frame */}
      ...
      {/* DOCUMENTOR phone */}
      <g>
        <text x="640" y="24" fill="#F4C26B" fontFamily={MONO} fontSize="12" letterSpacing="1.6" textAnchor="middle" fontWeight="700">
          DOCUMENTOR
        </text>
        <text x="640" y="40" fill="#E8A53B" fontFamily={SANS} fontSize="11" textAnchor="middle" fontStyle="italic">
        ...
        <text x="560" y="100" fill="#71717a" fontFamily={MONO} fontSize="11" letterSpacing="1">
          STEP 2 OF 7
        </text>
        {/* the one task */}
        <rect x="560" y="140" width="160" height="56" rx="6" fill="#E8A53B14" stroke="#E8A53B" strokeWidth="1" />
        <text x="572" y="170" fill="#d4d4d8" fontFamily={SANS} fontSize="12" textLength="136" lengthAdjust="spacingAndGlyphs">
          Upload your study permit.
        </text>
        <text x="572" y="186" fill="#71717a" fontFamily={MONO} fontSize="11" letterSpacing="1">
          &#x2191; TAP TO ADD FILE
        </text>
        {/* CTA */}
        <rect x="560" y="270" width="160" height="36" rx="18" fill="#E8A53B" />
        <text x="640" y="293" fill="#0F1216" fontFamily={MONO} fontSize="12" letterSpacing="1.2" textAnchor="middle" fontWeight="700">
          CONTINUE
        </text>
      </g>

      <text x="400" y="350" fill="#71717a" fontFamily={SANS} fontSize="12" textAnchor="middle" fontStyle="italic">
